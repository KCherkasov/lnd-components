...
/**
 * data model for {@link ru.rougegibbons.components.core.numbers.integer.PairIntComponentImpl} class.
 * @see ru.rougegibbons.components.core.numbers.integer.PairIntComponentImpl
 * @see ComponentModel
 */
